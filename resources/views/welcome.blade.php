...
<div class="row">
                 ...
                 <nav class="nav-home navbar-expand-lg navbar-light">
                     ...
                     <div id="my-nav" class="collapse navbar-collapse">
                         <ul class="navbar-nav mr-auto">
                             <li class="nav-item active" style="padding-left:2em;">
                             ...
                             <li class="nav-item active" style="padding-left:2em;">
                                 <a class="nav-link" href="#">Clients <span class="sr-only"></span></a>
                             </li>
                             <li class="nav-item active" style="padding-left:2em;">
    ...
    <div class="home-footer">
            <div class="p-2 ">Pluto Pro &copy; 2020 | Engineered by <a href="#">Innovus.lk</a></div>
    </div>
